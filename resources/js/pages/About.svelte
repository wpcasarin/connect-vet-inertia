...
<svelte:head>
  <title>ConnectVet ─ About us</title>
</svelte:head>

<Guests>
  <main
    class="container-fluid mx-auto mt-10 flex flex-grow p-2 sm:container sm:mt-20 sm:p-4">
    <div class="mx-auto max-w-7xl px-3 sm:px-0">
